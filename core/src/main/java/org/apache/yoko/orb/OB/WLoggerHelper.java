...
//
final public class WLoggerHelper
{
    public static void
    insert(org.omg.CORBA.Any any, WLogger val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "WLogger");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/WLogger:1.0";
    }
