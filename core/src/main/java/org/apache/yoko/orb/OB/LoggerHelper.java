...
//
final public class LoggerHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Logger val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "Logger");
        }
    ...
    id()
    {
        return "IDL:orb.yoko.apache.org/OB/Logger:1.0";
    }
