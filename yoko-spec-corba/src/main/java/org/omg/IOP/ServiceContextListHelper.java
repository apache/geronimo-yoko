...
public class ServiceContextListHelper
{
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "ServiceContextList", orb.create_sequence_tc(0, ServiceContextHelper.type()));
        }
    ...
    {
        ServiceContext[] _ob_v;
        int len0 = in.read_ulong();
        _ob_v = new ServiceContext[len0];
        for(int i0 = 0; i0 < len0; i0++)
            _ob_v[i0] = ServiceContextHelper.read(in);
        return _ob_v;
    }
    ...
    write(org.omg.CORBA.portable.OutputStream out, ServiceContext[] val)
    {
        ...
        for(int i0 = 0; i0 < len0; i0++)
            ServiceContextHelper.write(out, val[i0]);
    }
}
