...
{
    public static void
    insert(org.omg.CORBA.Any any, InvalidSlot val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "InvalidSlot", members);
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, InvalidSlot val)
    {
        out.write_string(id());
    }
}
