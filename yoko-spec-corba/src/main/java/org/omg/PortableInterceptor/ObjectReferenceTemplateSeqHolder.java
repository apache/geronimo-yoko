...
//
final public class ObjectReferenceTemplateSeqHolder implements org.omg.CORBA.portable.Streamable
{
    ...
    public
    ObjectReferenceTemplateSeqHolder(ObjectReferenceTemplate[] initial)
    {
        value = initial;
    }
