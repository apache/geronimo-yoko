...
final public class CodeSetContext implements org.omg.CORBA.portable.IDLEntity
{
    private static final String _ob_id = "IDL:omg.org/CONV_FRAME/CodeSetContext:1.0";
