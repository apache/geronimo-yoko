...
final public class BAD_INV_ORDERHelper {
    public static void insert(Any any, BAD_INV_ORDER val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "BAD_INV_ORDER", members);
        }
    ...
    public static BAD_INV_ORDER read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        BAD_INV_ORDER val = new BAD_INV_ORDER();
