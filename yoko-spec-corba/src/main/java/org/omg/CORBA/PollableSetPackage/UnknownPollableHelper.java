...
//
final public class UnknownPollableHelper
{
    public static void
    insert(org.omg.CORBA.Any any, UnknownPollable val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "UnknownPollable", members);
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, UnknownPollable val)
    {
        out.write_string(id());
    }
}
