...
final public class MARSHALHelper {
    public static void insert(Any any, MARSHAL val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "MARSHAL", members);
        }
    ...
    public static MARSHAL read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        MARSHAL val = new MARSHAL();
