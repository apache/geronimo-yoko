...
final public class TIMEOUTHelper {
    public static void insert(Any any, TIMEOUT val) {
        org.omg.CORBA.portable.OutputStream out = any.create_output_stream();
        write(out, val);
        any.read_value(out.create_input_stream(), type());
    }

    public static TIMEOUT extract(Any any) {
    ...
    public static TIMEOUT read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        TIMEOUT val = new TIMEOUT();
