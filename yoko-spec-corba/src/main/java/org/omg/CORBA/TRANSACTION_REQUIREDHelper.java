...
final public class TRANSACTION_REQUIREDHelper {
    public static void insert(Any any, TRANSACTION_REQUIRED val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "TRANSACTION_REQUIRED",
                    members);
        }
    ...
    public static TRANSACTION_REQUIRED read(
            org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        TRANSACTION_REQUIRED val = new TRANSACTION_REQUIRED();
