...
final public class INV_IDENTHelper {
    public static void insert(Any any, INV_IDENT val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "INV_IDENT", members);
        }
    ...
    public static INV_IDENT read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        INV_IDENT val = new INV_IDENT();
