...
final public class BAD_CONTEXTHelper {
    public static void insert(Any any, BAD_CONTEXT val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "BAD_CONTEXT", members);
        }
    ...
    public static BAD_CONTEXT read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        BAD_CONTEXT val = new BAD_CONTEXT();
