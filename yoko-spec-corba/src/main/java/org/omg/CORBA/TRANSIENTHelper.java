...
final public class TRANSIENTHelper {
    public static void insert(Any any, TRANSIENT val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "TRANSIENT", members);
        }
    ...
    public static TRANSIENT read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        TRANSIENT val = new TRANSIENT();
