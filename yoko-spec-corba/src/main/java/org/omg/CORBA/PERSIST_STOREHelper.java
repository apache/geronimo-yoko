...
final public class PERSIST_STOREHelper {
    public static void insert(Any any, PERSIST_STORE val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "PERSIST_STORE", members);
        }
    ...
    public static PERSIST_STORE read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        PERSIST_STORE val = new PERSIST_STORE();
