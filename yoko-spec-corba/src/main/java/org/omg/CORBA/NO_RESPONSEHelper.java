...
final public class NO_RESPONSEHelper {
    public static void insert(Any any, NO_RESPONSE val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "NO_RESPONSE", members);
        }
    ...
    public static NO_RESPONSE read(org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        NO_RESPONSE val = new NO_RESPONSE();
