                            ...
                            implements StructDef
{
    ...
    final public static java.lang.Class _ob_opsClass = StructDefOperations.class;
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    StructMember[] _ob_r = StructMemberSeqHelper.read(in);
                    return _ob_r;
                }
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                StructDefOperations _ob_self = (StructDefOperations)_ob_so.servant;
                try
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    StructMemberSeqHelper.write(out, _ob_a);
                    in = _invoke(out);
                    return;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
    ...
    //
    // IDL:omg.org/CORBA/StructDef/_OB_isForwardDcl:1.0
    //
    public boolean
    _OB_isForwardDcl()
    {
    ...
    //
    // IDL:omg.org/CORBA/StructDef/_OB_setForwardDcl:1.0
    //
    public void
