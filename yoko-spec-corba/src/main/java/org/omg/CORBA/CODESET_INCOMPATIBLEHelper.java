...
final public class CODESET_INCOMPATIBLEHelper {
    public static void insert(Any any, CODESET_INCOMPATIBLE val) {
    ...
    public static TypeCode type() {
        if (typeCode_ == null) {
            ...
            typeCode_ = orb.create_exception_tc(id(), "CODESET_INCOMPATIBLE",
                    members);
        }
    ...
    public static CODESET_INCOMPATIBLE read(
            org.omg.CORBA.portable.InputStream in) {
        if (!id().equals(in.read_string()))
            throw new MARSHAL();

        CODESET_INCOMPATIBLE val = new CODESET_INCOMPATIBLE();
