                             ...
                             implements Repository
{
    ...
    final public static java.lang.Class _ob_opsClass = RepositoryOperations.class;
    ...
    def_kind()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
    ...
    lookup_id(String _ob_a0)
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("lookup_id", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.lookup_id(_ob_a0);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
    ...
    get_canonical_typecode(org.omg.CORBA.TypeCode _ob_a0)
    {
        while(true)
        {
            if(!this._is_local())
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("get_canonical_typecode", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.get_canonical_typecode(_ob_a0);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
    ...
    //
    public PrimitiveDef
    get_primitive(PrimitiveKind _ob_a0)
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    PrimitiveKindHelper.write(out, _ob_a0);
                    in = _invoke(out);
                    PrimitiveDef _ob_r = PrimitiveDefHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("get_primitive", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.get_primitive(_ob_a0);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    StringDef _ob_r = StringDefHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("create_string", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.create_string(_ob_a0);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_ulong(_ob_a0);
                    in = _invoke(out);
                    WstringDef _ob_r = WstringDefHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("create_wstring", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.create_wstring(_ob_a0);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_ulong(_ob_a0);
                    IDLTypeHelper.write(out, _ob_a1);
                    in = _invoke(out);
                    SequenceDef _ob_r = SequenceDefHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("create_sequence", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.create_sequence(_ob_a0, _ob_a1);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    IDLTypeHelper.write(out, _ob_a1);
                    in = _invoke(out);
                    ArrayDef _ob_r = ArrayDefHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("create_array", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.create_array(_ob_a0, _ob_a1);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    FixedDef _ob_r = FixedDefHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("create_fixed", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                RepositoryOperations _ob_self = (RepositoryOperations)_ob_so.servant;
                try
                {
                    return _ob_self.create_fixed(_ob_a0, _ob_a1);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
