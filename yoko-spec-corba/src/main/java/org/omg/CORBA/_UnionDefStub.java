                           ...
                           implements UnionDef
{
    ...
    final public static java.lang.Class _ob_opsClass = UnionDefOperations.class;
    ...
    discriminator_type()
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("discriminator_type", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UnionDefOperations _ob_self = (UnionDefOperations)_ob_so.servant;
                try
                {
                    return _ob_self.discriminator_type();
                }
                finally
                {
    ...
    discriminator_type_def()
    {
        while(true)
        {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("discriminator_type_def", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UnionDefOperations _ob_self = (UnionDefOperations)_ob_so.servant;
                try
                {
                    return _ob_self.discriminator_type_def();
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
    ...
    public void
    discriminator_type_def(IDLType _ob_a)
    {
        while(true)
        {
            if(!this._is_local())
            ...
            else
            {
                ...
                try
                {
                    _ob_self.discriminator_type_def(_ob_a);
                    return;
                }
                finally
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    UnionMember[] _ob_r = UnionMemberSeqHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("members", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UnionDefOperations _ob_self = (UnionDefOperations)_ob_so.servant;
                try
                {
                    return _ob_self.members();
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    UnionMemberSeqHelper.write(out, _ob_a);
                    in = _invoke(out);
                    return;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
    ...
    //
    // IDL:omg.org/CORBA/UnionDef/_OB_isForwardDcl:1.0
    //
    public boolean
    _OB_isForwardDcl()
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("_OB_isForwardDcl", true);
                    in = _invoke(out);
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("_OB_isForwardDcl", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UnionDefOperations _ob_self = (UnionDefOperations)_ob_so.servant;
                try
                {
                    return _ob_self._OB_isForwardDcl();
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
    ...
    //
    // IDL:omg.org/CORBA/UnionDef/_OB_setForwardDcl:1.0
    //
    public void
    _OB_setForwardDcl(boolean _ob_a0)
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("_OB_setForwardDcl", true);
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("_OB_setForwardDcl", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                UnionDefOperations _ob_self = (UnionDefOperations)_ob_so.servant;
                try
                {
                    _ob_self._OB_setForwardDcl(_ob_a0);
                    return;
                }
                finally
                {
