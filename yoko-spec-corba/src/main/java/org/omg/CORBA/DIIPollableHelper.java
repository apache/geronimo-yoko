...
//
final public class DIIPollableHelper
{
    public static void
    insert(org.omg.CORBA.Any any, DIIPollable val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_value_tc(id(), "DIIPollable", org.omg.CORBA.VM_ABSTRACT.value, null, members);
        }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (DIIPollable)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, DIIPollable val)
    {
