...
//
final public class RequestProcessingPolicyHolder implements org.omg.CORBA.portable.Streamable
{
    public RequestProcessingPolicy value;

    public
    RequestProcessingPolicyHolder()
    {
    }
    ...
    {
        RequestProcessingPolicyHelper.write(out, value);
    }
