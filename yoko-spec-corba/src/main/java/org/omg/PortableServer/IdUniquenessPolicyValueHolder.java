...
//
final public class IdUniquenessPolicyValueHolder implements org.omg.CORBA.portable.Streamable
{
    ...
    public
    IdUniquenessPolicyValueHolder(IdUniquenessPolicyValue initial)
    {
        value = initial;
    }
