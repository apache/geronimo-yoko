...
{
    public static void
    insert(org.omg.CORBA.Any any, ThreadPolicyValue val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_enum_tc(id(), "ThreadPolicyValue", members);
        }
    ...
    {
        ThreadPolicyValue _ob_v;
        _ob_v = ThreadPolicyValue.from_int(in.read_ulong());
        return _ob_v;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, ThreadPolicyValue val)
    {
