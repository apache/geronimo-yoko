...
{
    public static void
    insert(org.omg.CORBA.Any any, ServantLocator val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "ServantLocator");
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, ServantLocator val)
    {
        throw new org.omg.CORBA.MARSHAL();
    }
