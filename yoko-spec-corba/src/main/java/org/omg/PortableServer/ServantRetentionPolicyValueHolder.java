...
//
final public class ServantRetentionPolicyValueHolder implements org.omg.CORBA.portable.Streamable
{
    ...
    public
    ServantRetentionPolicyValueHolder(ServantRetentionPolicyValue initial)
    {
        value = initial;
    }
