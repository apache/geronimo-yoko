...
{
    public static void
    insert(org.omg.CORBA.Any any, DynSequence val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "DynSequence");
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, DynSequence val)
    {
        throw new org.omg.CORBA.MARSHAL();
    }
