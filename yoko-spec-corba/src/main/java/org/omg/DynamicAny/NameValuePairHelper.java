...
public class NameValuePairHelper
{
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_struct_tc(id(), "NameValuePair", members);
        }
    ...
    {
        NameValuePair _ob_v = new NameValuePair();
        _ob_v.id = FieldNameHelper.read(in);
    ...
    {
        FieldNameHelper.write(out, val.id);
