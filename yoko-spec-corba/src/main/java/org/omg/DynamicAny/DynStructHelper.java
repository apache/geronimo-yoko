...
{
    public static void
    insert(org.omg.CORBA.Any any, DynStruct val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "DynStruct");
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, DynStruct val)
    {
        throw new org.omg.CORBA.MARSHAL();
    }
