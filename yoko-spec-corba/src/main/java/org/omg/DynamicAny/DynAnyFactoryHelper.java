...
{
    public static void
    insert(org.omg.CORBA.Any any, DynAnyFactory val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = ((org.omg.CORBA_2_4.ORB)orb).create_local_interface_tc(id(), "DynAnyFactory");
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, DynAnyFactory val)
    {
        throw new org.omg.CORBA.MARSHAL();
    }
