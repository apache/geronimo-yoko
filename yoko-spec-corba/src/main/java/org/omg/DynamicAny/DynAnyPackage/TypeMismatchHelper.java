...
{
    public static void
    insert(org.omg.CORBA.Any any, TypeMismatch val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_exception_tc(id(), "TypeMismatch", members);
        }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, TypeMismatch val)
    {
        out.write_string(id());
    }
}
