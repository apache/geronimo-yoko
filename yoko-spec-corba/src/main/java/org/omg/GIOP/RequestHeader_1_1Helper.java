...
//
final public class RequestHeader_1_1Helper
{
    public static void
    insert(org.omg.CORBA.Any any, RequestHeader_1_1 val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[6].name = "requesting_principal";
            members[6].type = orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_Principal);

            typeCode_ = orb.create_struct_tc(id(), "RequestHeader_1_1", members);
        }
