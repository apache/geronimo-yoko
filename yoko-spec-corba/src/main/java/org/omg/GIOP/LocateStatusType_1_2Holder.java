...
//
final public class LocateStatusType_1_2Holder implements org.omg.CORBA.portable.Streamable
{
    public LocateStatusType_1_2 value;

    public
    LocateStatusType_1_2Holder()
    {
    }

    public
    LocateStatusType_1_2Holder(LocateStatusType_1_2 initial)
    {
        value = initial;
    }
