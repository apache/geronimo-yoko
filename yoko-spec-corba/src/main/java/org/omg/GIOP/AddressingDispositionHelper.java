...
//
final public class AddressingDispositionHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "AddressingDisposition", orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_short));
        }
