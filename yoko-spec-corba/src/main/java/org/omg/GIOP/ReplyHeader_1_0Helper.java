...
//
final public class ReplyHeader_1_0Helper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[2].name = "reply_status";
            members[2].type = ReplyStatusType_1_2Helper.type();

            typeCode_ = orb.create_struct_tc(id(), "ReplyHeader_1_0", members);
        }
    ...
    {
        ReplyHeader_1_0 _ob_v = new ReplyHeader_1_0();
