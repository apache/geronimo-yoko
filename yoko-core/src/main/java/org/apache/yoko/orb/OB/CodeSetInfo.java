...
public enum CodeSetInfo {
    ...
    ISO_8859_1_1987("ISO 8859-1:1987; Latin Alphabet No. 1", 0x00010001, 1, new short[]{0x0011}),
    ISO_8859_2_1987("ISO 8859-2:1987; Latin Alphabet No. 2", 0x00010002, 1, new short[]{0x0012}),
    ISO_8859_3_1988("ISO 8859-3:1988; Latin Alphabet No. 3", 0x00010003, 1, new short[]{0x0013}),
    ISO_8859_4_1988("ISO 8859-4:1988; Latin Alphabet No. 4", 0x00010004, 1, new short[]{0x0014}),
    ISO_IEC_8859_5_1988("ISO/IEC 8859-5:1988; Latin-Cyrillic Alphabet", 0x00010005, 1, new short[]{0x0015}),
    ISO_8859_6_1987("ISO 8859-6:1987; Latin-Arabic Alphabet", 0x00010006, 1, new short[]{0x0016}),
    ISO_8859_7_1987("ISO 8859-7:1987; Latin-Greek Alphabet", 0x00010007, 1, new short[]{0x0017}),
    ISO_8859_8_1988("ISO 8859-8:1988; Latin-Hebrew Alphabet", 0x00010008, 1, new short[]{0x0018}),
    ISO_IEC_8859_9_1989("ISO/IEC 8859-9:1989; Latin Alphabet No. 5", 0x00010009, 1, new short[]{0x0019}),
    ...
    ISO_646_1991_IRV("ISO 646:1991 IRV (International Reference Version)", 0x00010020, 1, new short[]{0x0001}),
    ISO_IEC_10646_1_1993__UCS2_L1("ISO/IEC 10646-1:1993; UCS-2, Level 1", 0x00010100, 2, new short[]{0x1000}),
    ...
    ISO_IEC_10646_1_1993__UTF16("ISO/IEC 10646-1:1993; UTF-16, UCS Transformation Format 16-bit form", 0x00010109, 2, new short[]{0x1000}),
    ...
    X_Open_UTF_8("X/Open UTF-8; UCS Transformation Format 8 (UTF-8)", 0x05010001, 6, new short[]{0x1000}),
    ...
    public static int getRegistryIdForName(String name) {
        ...
        for (final CodeSetInfo value: REGISTRY) {
            if (value.description.contains(name)) return value.rgy_value;
        }

        //
        // Name not found
        //
        return NONE.rgy_value;
    }
    ...
    public static CodeSetInfo forRegistryId(int rgy_value) {
        ...
        //
        for (final CodeSetInfo value: REGISTRY) {
            if (value.rgy_value == rgy_value) return value;
        }
