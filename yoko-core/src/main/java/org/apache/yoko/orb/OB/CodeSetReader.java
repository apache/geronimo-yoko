...
public abstract class CodeSetReader {
    ...
    abstract char read_char(BufferReader bufferReader) throws DATA_CONVERSION;

    abstract char read_wchar(BufferReader bufferReader, int len) throws DATA_CONVERSION;
