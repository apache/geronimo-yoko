...
public abstract class CodeSetWriter {
    ...
    abstract void write_char(BufferWriter bufferWriter, char v) throws DATA_CONVERSION;

    abstract void write_wchar(BufferWriter bufferWriter, char v) throws DATA_CONVERSION;
